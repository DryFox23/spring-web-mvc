...
public class RestTemplateTest {
    ...
    @Test
    void addTodo() {
        String url ="http://localhost:" + port + "/add/todo";

        HttpHeaders headers = new HttpHeaders();
        headers.setAccept(List.of(MediaType.APPLICATION_JSON));

        MultiValueMap<String, Object> form = new LinkedMultiValueMap<>();
        form.add("todo", "Learn Spring Web MVC with RestTemplate");
        ...
        Assertions.assertEquals("Learn Spring Web MVC with RestTemplate",response.getBody().get(0));
    }

    @Test
    void getTodo() {
        String url ="http://localhost:" + port + "/get/todo";
